...
const T = {
 ...
 en: {
  ...
  desc: (<><span style={{color:"#d4f7e0",fontSize:"22px"}}>Use <span style={{color:"#60a5fa",fontWeight:"bold"}}>①②③④⑤</span> with arithmetic ops<br/>to reach the <span style={{color:"#ef4444",fontWeight:"bold"}}>⑥</span> target!<br/>Time Attack!</span><br/><br/><span style={{fontSize:"27px",color:"#fbbf24",fontWeight:"bold"}}>"There's no one right answer to happiness."</span><br/><span style={{fontSize:"22px",color:"#fbbf24",fontStyle:"italic",fontWeight:"bold"}}>Think beyond the answer.</span></>),
 ...
 pt: {
  ...
  desc: (<><span style={{color:"#d4f7e0",fontSize:"22px"}}>Use <span style={{color:"#60a5fa",fontWeight:"bold"}}>①②③④⑤</span> com operações<br/>para chegar ao número <span style={{color:"#ef4444",fontWeight:"bold"}}>⑥</span> alvo!<br/>Time Attack!</span><br/><br/><span style={{fontSize:"27px",color:"#fbbf24",fontWeight:"bold"}}>"Não há uma resposta certa para a felicidade."</span><br/><span style={{fontSize:"22px",color:"#fbbf24",fontStyle:"italic",fontWeight:"bold"}}>Think beyond the answer.</span></>),
