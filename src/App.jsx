...
const T = {
  ...
  en: {
    ...
    desc: "Tire cartas! Use 5 cartas para chegar ao numero alvo!",
    toBeHappy: "to be happy... 🍀", tutHint1: "Rosa - Tutorial primeiro!", tutHint2: "Amarelo - Jogo real!",
    by: "by NPO Foster Partner", back: "Voltar", surrender: "Pular", surrenderTitle: "Resposta", surrenderSub: "Uma solucao!", surrenderNext: "Proximo 🃏", tut4surrender: "Se travar, pressione Pular.",
    tutBanner: "Tutorial 🩷", backToTitle: "Inicio", next: "Proximo",
    tut1: "O cronometro comeca ao iniciar! ⏱", target: "⑥ ALVO",
    tut2: "Este e o Alvo! Chegue neste numero!",
    tut3: "Use as 5 cartas com +−×÷ para chegar ao alvo!",
    tut3b: "Pode usar operadores quantas vezes quiser!",
    tut4: "Grite Fospa! e pressione o botao! Se travar, pressione Pular.",
    fospa: "Fospa! 🙋", dealing: "Distribuindo...",
    fospaTime: "Fospa! ⏱", tutBanner2: "Tutorial 🩷", backOk: "Pode voltar para repensar!",
    tut5: "Combine numeros e operadores! Depois Verificar Resposta!",
    tut6: "Expressao inserida! Pressione Verificar Resposta!",
    exprPlaceholder: "Sua expressao aqui", check: "Verificar Resposta!", retry: "Tentar de Novo",
    errAll: "Use cada um de 5 cartas uma vez!", errExpr: "Expressao invalida!",
    correct: (t) => "Correto! = " + t + " 🍀", wrong: (v) => "Isso e igual a " + v,
    tutComplete: "Tutorial Completo! 🎉", correct2: "Correto! 🍬",
    tutResult1: "Seu tempo! No jogo real seu melhor e salvo! 🏆",
    tutResult2: "Pegou o jeito? Agora jogue de verdade!",
    nextGame: "Proximo Jogo 🃏", about: "Sobre o CLOVER",
    newRecord: "Novo Recorde! 🎉", currentBest: "Melhor:",
    nextGame2: "Proximo 🃏", toTitle: "Inicio",
  ...
  pt: {
    ...
    tut1: "O cronometro comeca ao iniciar! ⏱", target: "⑥ ALVO",
    tut2: "Este e o Alvo! Chegue neste numero!",
    tut3: "Use as 5 cartas com operadores para chegar ao alvo!",
    tut3b: "Pode usar operadores quantas vezes quiser!",
    tut4: "Grite Fospa! e pressione o botao! Se travar, pressione Pular.",
    fospa: "Fospa! 🙋", dealing: "Distribuindo...",
    fospaTime: "Fospa! ⏱", tutBanner2: "Tutorial 🩷", backOk: "Pode voltar para repensar!",
